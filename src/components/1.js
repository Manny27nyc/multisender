...
//   }
// };
export let FirstStep = withWizard(
  inject("UiStore")(
    observer(
            ...
            <div>
              <div className="description">
                <ol>
                  ...
                  <li>
                    Enter comma-separated list of addresses and values to send
                  </li>
                  <li>
              ...
              <Form className="form">
                ...
                <div className="form-inline">
                  <div className="form-inline-i form-inline-i_token-address-values">
                    <label
                      htmlFor="token-address-values"
                      className="multisend-label"
                    >
